                   ...
                   destinationType:(MJPopupViewDestination)destinationType dismissed:(void(^)(void))dismissed
{
    ...
    [self presentPopupView:popupViewController.view animationType:animationType destinationType:MJPopupViewDestinationCenter dismissed:dismissed];
}

- (void)presentPopupViewController:(UIViewController*)popupViewController animationType:(MJPopupViewAnimation)animationType destinationType:(MJPopupViewDestination)destinationType
{
    [self presentPopupView:popupViewController.view animationType:animationType destinationType:destinationType dismissed:nil];
}
...
- (void)presentPopupView:(UIView*)popupView animationType:(MJPopupViewAnimation)animationType destinationType:(MJPopupViewDestination)destinationType
{
    [self presentPopupView:popupView animationType:animationType destinationType:destinationType dismissed:nil];
}

- (void)presentPopupView:(UIView*)popupView animationType:(MJPopupViewAnimation)animationType destinationType:(MJPopupViewDestination)destinationType dismissed:(void(^)(void))dismissed
{
    UIView *sourceView = [self topView];
...
//    self.mj_popupBackgroundView.backgroundColor = [UIColor clearColor];
    ...
    switch (animationType) {
        ...
        case MJPopupViewAnimationSlideRightLeft:
        case MJPopupViewAnimationSlideRightRight:
            [self slideViewIn:popupView sourceView:sourceView overlayView:overlayView withAnimationType:animationType destinationType:destinationType];
            break;
        default:
...
- (void)slideViewIn:(UIView*)popupView sourceView:(UIView*)sourceView overlayView:(UIView*)overlayView
  withAnimationType:(MJPopupViewAnimation)animationType  destinationType:(MJPopupViewDestination)destinationType
{
    ...
    {
        case MJPopupViewDestinationTop:
            popupEndRect = CGRectMake((sourceSize.width - popupSize.width) / 2,
                    0,
                    popupSize.width,
                    popupSize.height);
            break;
       case MJPopupViewDestinationBottom:
            popupEndRect = CGRectMake((sourceSize.width - popupSize.width) / 2,
