//
//  DuanXinChongzhiViewController.m
//  beaver
//
...
@interface DuanXinChongzhiViewController ()
...
@implementation DuanXinChongzhiViewController
...
//    }
    ...
    NSString *countStr = [NSString stringWithFormat:@"%@ 条",_msg_count ];
    NSMutableAttributedString *attributedStr = [[NSMutableAttributedString alloc]initWithString:countStr];
    [attributedStr addAttribute:NSForegroundColorAttributeName value:UIColorFromRGB(0xff3800) range:NSMakeRange(0, _msg_count.length)];
    [attributedStr addAttribute:NSForegroundColorAttributeName value:UIColorFromRGB(0x333333) range:NSMakeRange(_msg_count.length,countStr.length - _msg_count.length)];
    ...
    UILabel * tip = [[UILabel alloc] initWithFrame:CGRectMake(x, CGRectGetMaxY(_lastBtn.frame)+20, kScreenW - 2 * x, h * 3)];
    NSString *tipStr = @"*若短信剩余0条，则挂机后不会发短信给业主，业主无法回拨！";
    NSMutableAttributedString *tipStr1 = [[NSMutableAttributedString alloc]initWithString:tipStr];
    [tipStr1 addAttribute:NSForegroundColorAttributeName value:UIColorFromRGB(0xff3800) range:NSMakeRange(0, 1)];
    [tipStr1 addAttribute:NSForegroundColorAttributeName value:UIColorFromRGB(0x333333) range:NSMakeRange(1,countStr.length - 1)];
    tip.attributedText = tipStr1;
    tip.textAlignment = NSTextAlignmentLeft;
    tip.font = [UIFont systemFontOfSize:16.0f];
    tip.numberOfLines = 0;
