//
//  MortgageWeiJieZhangTableViewCell.m
//  dev-beaver
//
...
@interface MortgageWeiJieZhangTableViewCell ()
...
@implementation MortgageWeiJieZhangTableViewCell
...
- (void)setUI{
    ...
    [_confir setTitle:@"待办费取消" forState:UIControlStateNormal];
