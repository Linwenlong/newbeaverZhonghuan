...
//        NSLog(@"[vc isViewLoaded]=%@",vc.viewIfLoaded);
...
- (void)scrollToIndex:(NSInteger)toIndex
{
    ...
    if (self.ckslideMenuDelegate && [self.ckslideMenuDelegate respondsToSelector:@selector(changeTitle:)]) {
        [self.ckslideMenuDelegate changeTitle:_currentIndex];
    }
