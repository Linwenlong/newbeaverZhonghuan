...
typedef NS_ENUM(NSInteger,HooDatePickerMode) {
    HooDatePickerModeYear,     // Displays year)
    HooDatePickerModeTen,     // Displays month, up and Down for ten day)
    HooDatePickerModeUpAndDown,     // Displays month, up and Down)
...
- (instancetype)initWithSliderSuperView:(UIView*)superView;//侧滑的view
