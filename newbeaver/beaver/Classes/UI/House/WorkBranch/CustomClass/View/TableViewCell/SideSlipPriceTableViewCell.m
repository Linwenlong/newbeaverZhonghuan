...
+ (instancetype)createCellWithIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.backView.layer.cornerRadius = 4.0f;
    cell.backView.clipsToBounds = YES;
    cell.startBtn.layer.cornerRadius = 3.0f;
    cell.startBtn.clipsToBounds = YES;
    cell.endBtn.layer.cornerRadius = 3.0f;
    cell.endBtn.clipsToBounds = YES;
...
- (void)updateCellWithModel:(ZYSideSlipFilterRegionModel *__autoreleasing *)model
    ...
    _regionTitle.text = self.regionModel.regionTitle;
    _regionModel.selectedItemList = @[_start,_end];
}

- (void)resetData {
    [_startBtn setTitle:@"开始时间" forState:UIControlStateNormal];
    [_endBtn setTitle:@"截至时间" forState:UIControlStateNormal];
