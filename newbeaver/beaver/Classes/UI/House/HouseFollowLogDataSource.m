...
@implementation HouseFollowLogDataSource
{
...
- (CGFloat)heightOfRow:(NSInteger)row
{
    ...
    {
        EBHouseFollowLog *log = self.dataArray[row];
...
//    NSLog(@"dataArray=%@",self.dataArray);
    ...
    if(cell == nil)
    {
        ...
        UILabel *user = [self createLabel:CGRectMake(15, 10, userSize.width, userSize.height) color:[EBStyle blackTextColor] font:[UIFont systemFontOfSize:14.0] text:log.user alignment:NSTextAlignmentLeft];
        ...
        CGSize waySize = [EBViewFactory textSize:log.way font:[UIFont systemFontOfSize:12] bounding:CGSizeMake([EBStyle screenWidth] - 14 - timeSize.width - 10 - 14, 640)];
        ...
        if (log.is_tel_record)
        {
            ...
            if (url && (url.length > 0))
            {
                [self addImage:view name:@"follow_audio_icon" xfloat:15 yfloat:34];
                ...
                if (log.content && (log.content.length > 0))
                {
                    ...
                    UILabel *audioNoteText = [[UILabel alloc] initWithFrame:CGRectMake(10, 0, 270, [EBViewFactory textSize:log.content font:[UIFont systemFontOfSize:14] bounding:CGSizeMake(290, 640)].height)];
            ...
            else
            {
                ...
                if (byetype == 0)
                {
                    [self addImage:view name:@"follow_audio_play" xfloat:14 yfloat:34];
//                    [self addImage:view name:@"follow_audio_wait" xfloat:14 yfloat:34];
        ...
        else
        {
            ...
            CGSize contentSize = [EBViewFactory textSize:log.content font:[UIFont systemFontOfSize:14] bounding:CGSizeMake(300, 640)];
            UILabel *content = [self createLabel:CGRectMake(15, 10 + userSize.height + verticalGap, 300, contentSize.height) color:[EBStyle blackTextColor] font:[UIFont systemFontOfSize:14.0] text:log.content alignment:NSTextAlignmentLeft];
            [view addSubview:content];
        }
        cell = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"cell"];
        [cell.contentView addSubview:view];
        [cell.contentView addSubview:[EBViewFactory tableViewSeparatorWithRowHeight:height - 0.5 leftMargin:15.0]];
    }
