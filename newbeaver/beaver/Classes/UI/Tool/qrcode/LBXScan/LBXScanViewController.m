...
- (void)drawScanView
{
    if (!_qRScanView)
    {
        ...
        _qRScanViewTip = [[UILabel alloc]initWithFrame:CGRectMake(0, (SCReenHeight -(SCReenWidth - 120))/2.0 + ( SCReenWidth - 120) - 20 , kScreenW, 30)];
        
        _qRScanViewTip.text = @"扫描合同右上角二维码";
        _qRScanViewTip.font = [UIFont systemFontOfSize:15.0f];
        _qRScanViewTip.textAlignment = NSTextAlignmentCenter;
        _qRScanViewTip.textColor = [UIColor grayColor];
//        _qRScanViewTip.backgroundColor = [UIColor redColor];
        
        [_qRScanView addSubview:_qRScanViewTip];
    }
