...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        _imageView.frame = CGRectMake(0, 0, CGRectGetWidth(_imageBackgroundView.frame), CGRectGetHeight(_imageBackgroundView.frame) );
...
- (void)setImage:(UIImage *)image{
        ...
        _imageBackgroundView.backgroundColor = [UIColor colorWithPatternImage:_image];
}
