...
@property (nonatomic, assign) BOOL is_showClear;    //是否显示清除按钮
...
- (void)initSubViews
{
    ...
    [self.finishBtn setTitleColor:UIColorFromRGB(0xff3800)  forState:UIControlStateNormal];
    ...
    if (_is_showClear == YES) {
        [self.cancelBtn setTitle:@"清空" forState:UIControlStateNormal];
    }else{
        [self.cancelBtn setTitle:@"取消" forState:UIControlStateNormal];
    }
    [self.cancelBtn setTitleColor:UIColorFromRGB(0xff3800) forState:UIControlStateNormal];
